...
- A [phone number ](https://docs.welco.ai/phone-number-setup/get-a-number)configured for human agent routing
...
- If the human agent doesn't answer within the timeout period, the call automatically transfers to the [AI receptionist](https://docs.welco.ai/getting-started/quick-setup)
