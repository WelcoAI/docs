...
If you haven't signed up yet, start at `https://app.welco.ai/signup`.
...
Your AI receptionist needs a phone number to answer calls.
...
1. Click **Import Existing Number**
...
In the **Prompt** section, add this basic template:
